...
public abstract class CasCouchbaseDAO<DomainObject extends JsonDO> extends CouchbaseDAO<DomainObject> implements ICasCouchbaseDAO<DomainObject> {
	...
	public CasCouchbaseDAO( CouchbaseDataSource dataSource) {
		super( dataSource);
	}
...
//		if ( Strings.isNullOrEmpty( objectToPersist.id()) ) {
//			throw new IllegalArgumentException( "invalid targetId" );
//		}
//
//		String key = getKeyFromId( objectToPersist.id() );
//
